...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "business_type" ] = array( "url" => "business_type", "type" => 0 );
	$projectEntitiesReverse[ "business_type" ] = "business_type";
	$projectEntities[ "channel" ] = array( "url" => "channel", "type" => 0 );
	$projectEntitiesReverse[ "channel" ] = "channel";
	$projectEntities[ "country" ] = array( "url" => "country", "type" => 0 );
	$projectEntitiesReverse[ "country" ] = "country";
	$projectEntities[ "group" ] = array( "url" => "group", "type" => 0 );
	$projectEntitiesReverse[ "group" ] = "group";
	$projectEntities[ "stock_type" ] = array( "url" => "stock_type", "type" => 0 );
	$projectEntitiesReverse[ "stock_type" ] = "stock_type";
	$projectEntities[ "province" ] = array( "url" => "province", "type" => 0 );
	$projectEntitiesReverse[ "province" ] = "province";
	$projectEntities[ "product_type" ] = array( "url" => "product_type", "type" => 0 );
	$projectEntitiesReverse[ "product_type" ] = "product_type";
	$projectEntities[ "personal_channel" ] = array( "url" => "personal_channel", "type" => 0 );
	$projectEntitiesReverse[ "personal_channel" ] = "personal_channel";
	$projectEntities[ "personal_agenda_repeat_date" ] = array( "url" => "personal_agenda_repeat_date", "type" => 0 );
	$projectEntitiesReverse[ "personal_agenda_repeat_date" ] = "personal_agenda_repeat_date";
	$projectEntities[ "personal_agenda" ] = array( "url" => "personal_agenda", "type" => 0 );
	$projectEntitiesReverse[ "personal_agenda" ] = "personal_agenda";
	$projectEntities[ "outbox_telegram" ] = array( "url" => "outbox_telegram", "type" => 0 );
	$projectEntitiesReverse[ "outbox_telegram" ] = "outbox_telegram";
	$projectEntities[ "personal" ] = array( "url" => "personal", "type" => 0 );
	$projectEntitiesReverse[ "personal" ] = "personal";
	$projectEntities[ "order_type" ] = array( "url" => "order_type", "type" => 0 );
	$projectEntitiesReverse[ "order_type" ] = "order_type";
	$projectEntities[ "membership_type" ] = array( "url" => "membership_type", "type" => 0 );
	$projectEntitiesReverse[ "membership_type" ] = "membership_type";
	$projectEntities[ "loop_type" ] = array( "url" => "loop_type", "type" => 0 );
	$projectEntitiesReverse[ "loop_type" ] = "loop_type";
	$projectEntities[ "outbox_mail_aws" ] = array( "url" => "outbox_mail_aws", "type" => 0 );
	$projectEntitiesReverse[ "outbox_mail_aws" ] = "outbox_mail_aws";
	$projectEntities[ "lookup_token" ] = array( "url" => "lookup_token", "type" => 0 );
	$projectEntitiesReverse[ "lookup_token" ] = "lookup_token";
	$projectEntities[ "group_user_type" ] = array( "url" => "group_user_type", "type" => 0 );
	$projectEntitiesReverse[ "group_user_type" ] = "group_user_type";
	$projectEntities[ "group_operation_off" ] = array( "url" => "group_operation_off", "type" => 0 );
	$projectEntitiesReverse[ "group_operation_off" ] = "group_operation_off";
	$projectEntities[ "group_product" ] = array( "url" => "group_product", "type" => 0 );
	$projectEntitiesReverse[ "group_product" ] = "group_product";
	$projectEntities[ "group_member_order_detail" ] = array( "url" => "group_member_order_detail", "type" => 0 );
	$projectEntitiesReverse[ "group_member_order_detail" ] = "group_member_order_detail";
	$projectEntities[ "group_member_order" ] = array( "url" => "group_member_order", "type" => 0 );
	$projectEntitiesReverse[ "group_member_order" ] = "group_member_order";
	$projectEntities[ "group_member_agenda_subscriber" ] = array( "url" => "group_member_agenda_subscriber", "type" => 0 );
	$projectEntitiesReverse[ "group_member_agenda_subscriber" ] = "group_member_agenda_subscriber";
	$projectEntities[ "group_member_agenda" ] = array( "url" => "group_member_agenda", "type" => 0 );
	$projectEntitiesReverse[ "group_member_agenda" ] = "group_member_agenda";
	$projectEntities[ "group_member" ] = array( "url" => "group_member", "type" => 0 );
	$projectEntitiesReverse[ "group_member" ] = "group_member";
	$projectEntities[ "group_agenda_private" ] = array( "url" => "group_agenda_private", "type" => 0 );
	$projectEntitiesReverse[ "group_agenda_private" ] = "group_agenda_private";
	$projectEntities[ "group_agenda_general_logs" ] = array( "url" => "group_agenda_general_logs", "type" => 0 );
	$projectEntitiesReverse[ "group_agenda_general_logs" ] = "group_agenda_general_logs";
	$projectEntities[ "group_agenda" ] = array( "url" => "group_agenda", "type" => 0 );
	$projectEntitiesReverse[ "group_agenda" ] = "group_agenda";
	$projectEntities[ "group_agenda_repeat_date" ] = array( "url" => "group_agenda_repeat_date", "type" => 0 );
	$projectEntitiesReverse[ "group_agenda_repeat_date" ] = "group_agenda_repeat_date";
	$projectEntities[ "group_member_checkin" ] = array( "url" => "group_member_checkin", "type" => 0 );
	...
	$projectEntities[ "custom_group_agenda_type" ] = array( "url" => "custom_group_agenda_type", "type" => 6 );
