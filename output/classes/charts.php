...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("business_type" == $this->chrt_array['tables'][0])
			return true;
		if("channel" == $this->chrt_array['tables'][0])
			return true;
		if("country" == $this->chrt_array['tables'][0])
			return true;
		if("group" == $this->chrt_array['tables'][0])
			return true;
		if("stock_type" == $this->chrt_array['tables'][0])
			return true;
		if("province" == $this->chrt_array['tables'][0])
			return true;
		if("product_type" == $this->chrt_array['tables'][0])
			return true;
		if("personal_channel" == $this->chrt_array['tables'][0])
			return true;
		if("personal_agenda_repeat_date" == $this->chrt_array['tables'][0])
			return true;
		if("personal_agenda" == $this->chrt_array['tables'][0])
			return true;
		if("outbox_telegram" == $this->chrt_array['tables'][0])
			return true;
		if("personal" == $this->chrt_array['tables'][0])
			return true;
		if("order_type" == $this->chrt_array['tables'][0])
			return true;
		if("membership_type" == $this->chrt_array['tables'][0])
			return true;
		if("loop_type" == $this->chrt_array['tables'][0])
			return true;
		if("outbox_mail_aws" == $this->chrt_array['tables'][0])
			return true;
		if("lookup_token" == $this->chrt_array['tables'][0])
			return true;
		if("group_user_type" == $this->chrt_array['tables'][0])
			return true;
		if("group_operation_off" == $this->chrt_array['tables'][0])
			return true;
		...
		if("group_member_order" == $this->chrt_array['tables'][0])
			return true;
		if("group_member_agenda_subscriber" == $this->chrt_array['tables'][0])
			return true;
		if("group_member_agenda" == $this->chrt_array['tables'][0])
			return true;
		if("group_member" == $this->chrt_array['tables'][0])
			return true;
		if("group_agenda_private" == $this->chrt_array['tables'][0])
			return true;
		if("group_agenda_general_logs" == $this->chrt_array['tables'][0])
			return true;
		if("group_agenda" == $this->chrt_array['tables'][0])
			return true;
		if("group_agenda_repeat_date" == $this->chrt_array['tables'][0])
			return true;
