...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_group_agenda", " " . GetTableCaption("custom_group_agenda"));
$table = "custom_group_product";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
if( pageEnabled($table, 'print') || pageEnabled($table, 'rprint') || pageEnabled($table, 'export')  )
...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_group_product", " " . GetTableCaption("custom_group_product"));
$table = "custom_group_order";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
if( pageEnabled($table, 'print') || pageEnabled($table, 'rprint') || pageEnabled($table, 'export')  )
...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_group_order", " " . GetTableCaption("custom_group_order"));
$table = "custom_group_checkin";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
if( pageEnabled($table, 'print') || pageEnabled($table, 'rprint') || pageEnabled($table, 'export')  )
...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_group_checkin", " " . GetTableCaption("custom_group_checkin"));
$table = "custom_group";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_group", " " . GetTableCaption("custom_group"));
$table = "custom_personal_agenda";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
if( pageEnabled($table, 'print') || pageEnabled($table, 'rprint') || pageEnabled($table, 'export')  )
...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_personal_agenda", " " . GetTableCaption("custom_personal_agenda"));
$table = "custom_group_agenda_type";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
if( pageEnabled($table, 'print') || pageEnabled($table, 'rprint') || pageEnabled($table, 'export')  )
...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_group_agenda_type", " " . GetTableCaption("custom_group_agenda_type"));
$table = "custom_group_member_agenda";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
if( pageEnabled($table, 'print') || pageEnabled($table, 'rprint') || pageEnabled($table, 'export')  )
...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_group_member_agenda", " " . GetTableCaption("custom_group_member_agenda"));
$table = "custom_group_agenda_subscriber";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
if( pageEnabled($table, 'print') || pageEnabled($table, 'rprint') || pageEnabled($table, 'export')  )
...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_group_agenda_subscriber", " " . GetTableCaption("custom_group_agenda_subscriber"));
$table = "custom_personal_channel";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
if( pageEnabled($table, 'print') || pageEnabled($table, 'rprint') || pageEnabled($table, 'export')  )
...
$pageMask[$table] = $mask;
$tables[$table] = array("custom_personal_channel", " " . GetTableCaption("custom_personal_channel"));
